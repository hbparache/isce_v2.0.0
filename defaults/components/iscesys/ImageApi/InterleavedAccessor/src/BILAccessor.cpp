...
void BILAccessor::setData(char * buf, int row, int col, int numEl)
{
    ...
    {
        streampos  posNow = (row*LineWidth*Bands*SizeV) + ((streampos)(i*LineWidth*SizeV + col*SizeV));
...
void BILAccessor::getData(char * buf, int row, int col, int & numEl)
{
    ...
    for(int i = 0; i < Bands; ++i)
    {
        streampos  posNow = ((streampos)row*LineWidth*Bands*SizeV) + ((streampos)(i*LineWidth*SizeV + col*SizeV));
