...
extern "C"
{
	...
	**/
	void getLine_f(uint64_t * ptDataAccessor,char * dataLine, int * row);
        void getLineBand_f(uint64_t * ptDataAccessor, char * dataLine, int * band, int * row);
	/**
	...
	**/
	void setLine_f(uint64_t * ptDataAccessor,char * dataLine, int * row);
        void setLineBand_f(uint64_t * ptDataAccessor,char * dataLine, int * row, int * band);
	/**
	  ...
	  * @see  initSequentialAccessor_f().
	**/
	void getLineSequential_f(uint64_t * ptDataAccessor,  char * dataLine, int * eof);
        void getLineSequentialBand_f(uint64_t * ptDataAccessor, char * dataLine, int * band, int * eof);
