...
class EllipsoidTest(unittest.TestCase):
    ...
    def testRadiusOfCurvature(self):
        ...
        self.assertAlmostEquals(ans,rcurv,3)
    ...
    def notestLocalRadius(self):
        ...
        self.assertAlmostEquals(rad,ans,3)
    ...
    def testWGS84Ellipsoid(self):
        ...
        e2 = 0.0066943799901
        b = 6356752.314
        self.assertAlmostEquals(a, elp.a, places=3)
        self.assertAlmostEquals(e2, elp.e2, places=10)
        self.assertAlmostEquals(b, elp.b, places=3)
