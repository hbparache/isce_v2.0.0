...
PyObject * allocate_r_platvel1_C(PyObject* self, PyObject* args) 
{
	int dim1 = 0;
	if(!PyArg_ParseTuple(args, "i", &dim1))
	{
	...
	allocate_r_platvel1_f(&dim1);
	return Py_BuildValue("i", 0);
}

PyObject * deallocate_r_platvel1_C(PyObject* self, PyObject* args) 
{
	deallocate_r_platvel1_f();
	return Py_BuildValue("i", 0);
}

PyObject * allocate_r_platacc1_C(PyObject* self, PyObject* args) 
{
	int dim1 = 0;
	if(!PyArg_ParseTuple(args, "i", &dim1))
	{
	...
	allocate_r_platacc1_f(&dim1);
	return Py_BuildValue("i", 0);
}

PyObject * deallocate_r_platacc1_C(PyObject* self, PyObject* args) 
{
	deallocate_r_platacc1_f();
	return Py_BuildValue("i", 0);
}

PyObject * allocate_spectralShiftFrac_C(PyObject* self, PyObject* args) 
{
	int dim1 = 0;
	if(!PyArg_ParseTuple(args, "i", &dim1))
	{
	...
	allocate_spectralShiftFrac_f(&dim1);
	return Py_BuildValue("i", 0);
}

PyObject * deallocate_spectralShiftFrac_C(PyObject* self, PyObject* args) 
{
	deallocate_spectralShiftFrac_f();
	return Py_BuildValue("i", 0);
}

PyObject * allocate_linearResampCoeff_C(PyObject* self, PyObject* args) 
{
	int dim1 = 0;
	if(!PyArg_ParseTuple(args, "i", &dim1))
	{
	...
	allocate_linearResampCoeff_f(&dim1);
	return Py_BuildValue("i", 0);
}

PyObject * deallocate_linearResampCoeff_C(PyObject* self, PyObject* args) 
{
	deallocate_linearResampCoeff_f();
	return Py_BuildValue("i", 0);
}

PyObject * allocate_linearResampDeltas_C(PyObject* self, PyObject* args) 
{
	int dim1 = 0;
	if(!PyArg_ParseTuple(args, "i", &dim1))
	{
	...
	allocate_linearResampDeltas_f(&dim1);
	return Py_BuildValue("i", 0);
}

PyObject * deallocate_linearResampDeltas_C(PyObject* self, PyObject* args) 
{
	deallocate_linearResampDeltas_f();
	return Py_BuildValue("i", 0);
}
...
PyObject * setDeskewFlag_C(PyObject* self, PyObject* args) 
{
	char * varString;
	int varInt;
	if(!PyArg_ParseTuple(args, "s#", &varString ,&varInt))
	{
		return NULL;  
	}  
	setDeskewFlag_f(varString, &varInt);
	return Py_BuildValue("i", 0);
}
PyObject * setSecondaryRangeMigrationFlag_C(PyObject* self, PyObject* args) 
{
	...
	setSecondaryRangeMigrationFlag_f(varString, &varInt);
	return Py_BuildValue("i", 0);
}
